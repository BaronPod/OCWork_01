...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "Pods/AFMacros.framework"
  install_framework "Pods/AFNetworking.framework"
  install_framework "Pods/Base64.framework"
  install_framework "Pods/CoreTextLabel.framework"
  ...
  install_framework "Pods/EGOTableViewPullRefresh.framework"
  ...
  install_framework "Pods/SKBounceAnimation.framework"
  install_framework "Pods/SSCheckBoxView.framework"
  install_framework "Pods/STableViewController.framework"
  ...
  install_framework "Pods/ZAActivityBar.framework"
fi
